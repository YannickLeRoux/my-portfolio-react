...
class About extends Component {
  ...
  render() {
	...
	My first project was to create a <a href="http://receipts-organizer.herokuapp.com/" target="_blank" rel="noopener noreferrer">receipts organizer</a> app, one that could scan receipts and keep them organized in a database. I still have to make some improvements to it (i.e. the facility to scan with a phone, design, security, etc.,) but anybody can sign up for an account and import documents already scanned.</p>

            <p>I next decided to approve my JavaScript skills and learn React JS, following the <a href="https://courses.edx.org/certificates/ee19337ad1df495cb24f91648532eac3" target="_blank" rel="noopener noreferrer">University of Pennsylvania online course</a>.</p>
